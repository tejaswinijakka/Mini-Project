...
class MyCCart(Resource):
    ...
    def get(self):
        ...
        try:
            ...
            print(s)
            if(s[0]['COUNT(cid)']>=1):
                return query(f"""SELECT c.cid, item_name from agrotrades.cart c inner join agrotrades.commercial co on c.cid = co.cid  WHERE email = '{data['email']}'""")
            else:
...
class MyDCart(Resource):
    ...
    def get(self):
        ...
        try:
            ...
            print(s)
            if(s[0]['COUNT(did)']>=1):
                return query(f"""SELECT c.did, item_name from agrotrades.cart c inner join agrotrades.dairy d on c.did = d.did  WHERE email = '{data['email']}'""")
            else:
...
class MyGCart(Resource):
    ...
    def get(self):
        ...
        try:
            ...
            print(s)
            if(s[0]['COUNT(gid)']>=1):
                return query(f"""SELECT c.gid, item_name from agrotrades.cart c inner join agrotrades.grains g on c.gid = g.gid  WHERE email = '{data['email']}'""")
            else:
...
class MyVCart(Resource):
    ...
    def get(self):
        ...
        try:
            ...
            print(s)
            if(s[0]['COUNT(vid)']>=1):
                return query(f"""SELECT c.vid, item_name from agrotrades.cart c inner join agrotrades.vegfruits v on c.vid = v.vid  WHERE email = '{data['email']}'""")
            else:
